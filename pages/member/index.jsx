...
const Member = () => {
	...
	const goToNextStep = () => {
		...
		if (nextStep > memberProfileClone.length) {
			...
			// console.log("IDX", findIndex(memberProfileClone, { step: currentStep }), memberProfileClone);
	...
	const setCurrentStepInputClone = () => {
		let currentProfileCloneNew = findWhere(memberProfileClone, { step: currentStep });
								...
								<div className="wizard-inner">
									...
									<ul className="d-flex justify-content-center">
										{memberProfileClone.map((profileClone) => {
											...
											return (
												<li
													className={currentStep == profileClone.step && 'active'}
