const Offer = () => {
    ...
    const offer = {
        name: "First Offer",
        description: "This is the dummy offer...",
                                ...
                                <div className="pb-4 mt-1">
                                    <div className="table-responsive-sm shadow-soft rounded">
                                        ...
                                        <table className="table membership-table table-hover table-borderless ">
                                            <thead>
                                                <tr>
                                                    <th className="table-date table-primary text-capitalize">offer Name</th>
                                                    <th className="table-date table-primary text-capitalize">Description</th>
                                                    <th className="table-date table-primary text-capitalize">Expiry Date</th>
                                                    <th className="table-date table-primary text-capitalize">Active</th>
                                                    <th className="table-date table-primary text-capitalize">Actions</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                {/* {offers.map(offer => {
                                                ...
                                                {/* key={offer.id} */}
                                                <tr >
                                                    <td className="text-center text-capitalize">{offer.name}  </td>
                                                    <td className="text-center ">{offer.description}</td>
                                                    <td className="text-center ">{offer.expiry_date}</td>
                                                    <td className="text-center ">{offer.is_active ? "YES" : "NO"}</td>
