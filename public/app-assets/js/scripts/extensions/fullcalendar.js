...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var calendar = new FullCalendar.Calendar(calendarEl, {
    ...
    eventClick: function (info) {
      ...
      $(".modal-calendar .chip-wrapper").append($("<div className='chip chip-" + eventCategory + "'>" +
        "<div className='chip-body'>" +
        "<span className='chip-text'> " + eventText + " </span>" +
        "</div>" +
        "</div>"));
    },
  });
  ...
  $(".calendar-dropdown .dropdown-menu .dropdown-item").on("click", function () {
    ...
    $(".modal-calendar .chip-wrapper .chip").remove();
    $(".modal-calendar .chip-wrapper").append($("<div className='chip chip-" + selectedColor + "'>" +
      "<div className='chip-body'>" +
      "<span className='chip-text'> " + eventTag + " </span>" +
      "</div>" +
      "</div>"));
  });
