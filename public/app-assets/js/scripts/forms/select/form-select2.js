...
(function(window, document, $) {
  ...
  // Basic Select2 select
    ...
    function iconFormat(icon) {
        ...
        var $icon = "<i className='" + $(icon.element).data('icon') + "'></i>" + icon.text;
    ...
    function formatRepo (repo) {
      ...
      markup += "<div className='select2-result-repository__statistics'>" +
        "<div className='select2-result-repository__forks'><i className='icon-code-fork mr-0'></i> " + repo.forks_count + " Forks</div>" +
        "<div className='select2-result-repository__stargazers'><i className='icon-star5 mr-0'></i> " + repo.stargazers_count + " Stars</div>" +
        "<div className='select2-result-repository__watchers'><i className='icon-eye mr-0'></i> " + repo.watchers_count + " Watchers</div>" +
      "</div>" +
      "</div></div>";
