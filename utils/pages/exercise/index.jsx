			...
			let searchData = allEmployee.filter((employee) => {
				return Object.keys(employee).some((key) => {
					if (typeof employee[key] === 'string') {
						return employee[key].toLowerCase().includes(searchEmployee.toLowerCase());
					} else {
					...
					<div className="row">
						<div className="col-lg-3 col-sm-6 col-12">
							<div className="form-group">
								<div className="input-group mb-4">
									...
									/>
									<div className="input-group-append cursor-pointer" onClick={clearSearch}>
										<span className="input-group-text">
											<span className="fa fa-trash"></span>
										</span>
									</div>
									<div className="input-group-append cursor-pointer" onClick={handleSearch}>
										<span className="input-group-text">
						...
						<div className="col-lg-3 col-sm-6 col-12 mb-lg-0 mt-sm-2 offset-lg-6 text-sm-right text-center">
							<Link href="/add-employee/steps">
								<a className={'btn btn-pill mb-sm-0 mb-2  text_theme_primary custom_btn '}>
