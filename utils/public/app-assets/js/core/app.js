...
(function (window, document, $) {
  ...
  $(window).on("load", function () {
    ...
    $('a[data-action="reload"]').on("click", function () {
      ...
      // Block Element
      block_ele.block({
        message: '<div className="feather icon-refresh-cw icon-spin font-medium-2 text-primary"></div>',
  ...
  bookmarkStar.on("click", function (e) {
    ...
    for (var i = 0; i < arrList.length; i++) {
      ...
      $arrList +=
        ...
        "</span>" +
        "</div>" +
        '<span className="float-right bookmark-icon feather icon-star warning"></span>' +
        "</a>" +
        "</li>";
    }
    ...
    if (e.keyCode !== 38 && e.keyCode !== 40 && e.keyCode !== 13) {
      ...
      if (value != "") {
        ...
        var $startList = "",
          ...
          $htmlList = "",
          $bookmarkhtmlList = "",
          $pageList = '<li className=" d-flex align-items-center">' +
          '<a href="#" className="pb-25">' +
          '<h6 className="text-primary mb-0">Pages</h6>' +
          '</a>' +
          '</li>',
          $activeItemClass = "",
          $bookmarkIcon = "",
        ...
        $.getJSON("../../../app-assets/data/" + $filename + ".json", function (
          ...
          for (var i = 0; i < data.listItems.length; i++) {
            ...
            if (bookmark === true) {
              ...
              $bookmarkIcon =
                '<span className="float-right bookmark-icon feather icon-star' +
                activeClass +
                '"></span>';
            }
