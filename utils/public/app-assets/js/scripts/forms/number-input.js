...
(function (window, document, $) {
  ...
  $(".touchspin-icon").TouchSpin({
    buttondown_txt: '<i className="feather icon-chevron-down"></i>',
    buttonup_txt: '<i className="feather icon-chevron-up"></i>'
  });
  ...
  $(".touchspin-color").each(function (index) {
    ...
    $this.TouchSpin({
      ...
      buttonup_class: up,
      buttondown_txt: '<i className="feather icon-minus"></i>',
      buttonup_txt: '<i className="feather icon-plus"></i>'
    });
  });
