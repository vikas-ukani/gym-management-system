...
$(document).ready(function () {
  ...
  var customBadgeHTML = function (params) {
    ...
    if (params.value == "active") {
      color = "success"
      return "<div className='badge badge-pill badge-light-" + color + "' >" + params.value + "</div>"
  ...
  var customBulletHTML = function (params) {
    ...
    if (params.value == true) {
      color = "success"
      return "<div className='bullet bullet-sm bullet-" + color + "' >" + "</div>"
  ...
  var customIconsHTML = function (params) {
    ...
    var editIconHTML = "<a href='app-user-edit.html'><i className= 'users-edit-icon feather icon-edit-1 mr-50'></i></a>"
  ...
  var customAvatarHTML = function (params) {
    return "<span className='avatar'><img src='" + params.data.avatar + "' height='32' width='32'></span>" + params.value
  }
